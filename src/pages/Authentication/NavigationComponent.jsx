    ...
    <div className="min-h-screen flex flex-row">
      ...
      <div dir='rtl'  className="flex-1 flex flex-col items-center justify-center">
        ...
        <div className="w-full max-w-md">
          ...
          <div className=''> <Link to={'/'}><img src={Logo} alt="Logo" className=" h-20  lg:ms-[-100px] lg:mx-0 mx-auto lg:mt-0 mb-10 " /></Link></div>
  ...
  return (
    <>
      <Link
        to={to}
        className={`
          lg:px-[15%]  px-5 py-4 text-main_color border border-[#086cba]  hover:bg-[#d4f2fc] ${className} ${isActive ? 'bg-[#d4f2fc] hover:' : 'bg-white'}
        `}
      >
        {children}
      </Link>
