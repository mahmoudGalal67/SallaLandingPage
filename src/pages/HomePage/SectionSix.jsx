import img from "../../assets/5ab000141978a98e46cf9b53d3016935.png";
          ...
          <div className="md:px-[15%] md:mb-14 py-14 md:py-0">
            ...
            <div data-aos="fade-up" data-aos-duration="2000">
              ...
              <p className="py-4 text-lg text-gray-500 2xl:py-8 md:py-6 ">
                قم بالتوسع بسلاسة وحقق النمو على مستوى عالمي.{" "}
              </p>
              <div className="mt-4">
                <div className="flex flex-col   space-y-2 mt-4 ">
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <span className="text-[#4d4d4d] py-1 text-[1.2rem] ">
                      {" "}
                      قبول المدفوعات من أكثر من 79 دولة.{" "}
                    </span>
                  </div>
                  <div className="flex items-center gap-3">
                    <svg
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <span className="text-[#4d4d4d] py-1 text-[1.2rem]">
                      {" "}
                      إضافة مواقع ومتاجر متعددة ومستودعات.{" "}
                    </span>
                  </div>
                </div>
              </div>
