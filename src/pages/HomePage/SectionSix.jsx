...
import img from '../../assets/imges/4.png'
  ...
  return ( 
    ...
    <div className=''>
     ...
     data-aos-duration="2000">
            <h1 className="text-3xl font-semibold text-main_color xl:text-5xl lg:text-3xl">  تجارة لا تعرف حدودًا</h1>
        ...
        <div className="flex items-center text-right gap-3">
          ...
          <span className='text-[#4d4d4d] py-1 text-[1rem]'>دعم أكثر من 40 لغة .</span>
        </div>
        <div className="flex items-center gap-3">
          <MdOutlineKeyboardDoubleArrowLeft className="text-[#004d5a]" />
          <span  className='text-[#4d4d4d] py-1 text-[1rem] '> استقبال المدفوعات من أكثر من 79 دولة.</span>
        </div>
        <div className="flex items-center gap-3">
          <MdOutlineKeyboardDoubleArrowLeft className="text-[#004d5a]" />
          <span  className='text-[#4d4d4d] py-1 text-[1rem]' > شحن دولي يغطي معظم دول العالم.</span>
        </div>
        <div className="flex items-center gap-3">
          <MdOutlineKeyboardDoubleArrowLeft className="text-[#004d5a]" />
          <span  className='text-[#4d4d4d] py-1 text-[1rem]' > إمكانية إضافة فروع ومستودعات متعددة لمتجرك.</span>
        </div>
      </div>
      </div>
            </div>
