...
import img from '../../assets/imges/3.png'
  ...
  return ( 
    ...
    <div className='bg-[#f8f8f8]'>
     ...
     data-aos-duration="2000">
                       <h1 className="text-3xl font-semibold text-main_color xl:text-3xl lg:text-3xl"> مدفوعات آمنة، لتجارة مستدامة، وثقة متينة! </h1>
