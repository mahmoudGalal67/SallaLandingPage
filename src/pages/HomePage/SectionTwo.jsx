    ...
    return (
        ...
        data-aos-anchor-placement="top-bottom">
                    ...
                    <div className="text-base sm:text-lg md:text-xl lg:text-2xl font-normal pt-6 max-w-2xl text-center text-[#666666]">
                        أنشئ متجرك الإلكتروني، وانضمَّ لعشرات الآلاف من العلامات المحلية والعالمية الناجحة مع سلة بلس اليوم
                    </div>
                </div>
                        ...
                        <div className="flex items-center gap-4">
                            ...
                            <div>
                                <div className="text-xl sm:text-2xl md:text-3xl font-bold text-main_color">
                                    {counterOn && <CountUp start={0} end={12776} duration={2} delay={0} />}+
                                </div>
                                <div className="text-base sm:text-lg md:text-xl font-normal text-[#868686]">متجر إلكتروني</div>
                            </div>
                        </div>
                        <div className="flex items-center gap-4">
                            <div className="salla-border-style">
                            ...
                            <div>
                                <div className="text-xl sm:text-2xl md:text-3xl font-bold text-main_color">
                                    {counterOn && <CountUp start={0} end={5608799922} duration={2} delay={0} />}+
                                </div>
                                <div className="text-base sm:text-lg md:text-xl font-normal text-[#868686]">مبيعات المنصة</div>
                            </div>
                        </div>
                    </div>
                </div>
