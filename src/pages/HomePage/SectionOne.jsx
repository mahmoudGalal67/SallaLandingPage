import img from '../../assets/imges/1.png'
  ...
  return (
    ...
    <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 relative text-center  " >
      ...
      data-aos-anchor-placement="top-bottom">
        <h1
            className="max-w-2xl mx-auto text-center font-manrope font-bold md:text-[44px] text-[35px] text-main_color mb-5  leading-[50px]">
