import img from '../../assets/imges/2.png'
  ...
  return ( 
    ...
    <>
     ...
     data-aos-duration="2000">
            <h1 className="text-3xl font-semibold text-main_color xl:text-5xl lg:text-3xl">تحكم في كل شئ</h1>
            <p className="py-4 text-xl text-gray-500 2xl:py-8 md:py-6 ">
                   قم بإدارة متجرك ومبيعاتك ومدفوعاتك من مكان واحد في لوحة تحكم سهلة وبسيطة 
            </p>
            <div className="mt-4">
            <div className="flex flex-col space-y-2 mt-4">
        <div className="flex items-center gap-3">
          <GrDomain className="text-[#004d5a] icons" />
          <span className='text-[#4d4d4d] py-1 text-[1.2rem] font-semibold'> اربط نطاقك بسهولة </span>
        </div>
        <div className="flex items-center gap-3">
          <MdOutlinePayments className="text-[#004d5a]" />
          <span  className='text-[#4d4d4d] py-1 text-[1.2rem] font-semibold'> إعدادات المدفوعات وخيارات الشحن </span>
        </div>
        <div className="flex items-center gap-3">
          <MdOutlineNotificationsActive className="text-[#343E52]" />
          <span  className='text-[#4d4d4d] py-1 text-[1.2rem] font-semibold' > تنبيهات عند كل طلب جديد </span>
        </div>
      </div>
            </div>
            </div>
